...
travis = False  # replace with travis_checker if you use travis or GitHub Actionss
...
class opParams:
  def __init__(self):
    ...
    self.fork_params = {'camera_offset': Param(0.06, VT.number, 'Your camera offset to use in lane_planner.py', live=True),
                        ...
                        'slowdown_for_curves': Param(False, bool, 'Whether your car will slow down for curves using the old planner code from 0.5/0.6'),
                        ...
                        'corollaTSS2_use_indi': Param(True, bool, 'Enable this to use INDI for lat with your TSS2 Corolla'),
