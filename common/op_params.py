...
class opParams:
  def __init__(self):
    ...
    self.fork_params = {'awareness_factor': Param(100., VT.number, 'Multiplier for the awareness times'),
                        ...
                        'camera_offset': Param(-.06, VT.number, 'Your camera offset to use in lane_planner.py', live=True),
                        ...
                        'mpc_offset': Param(5.0, VT.number, 'Offset model braking by how many m/s. Lower numbers equals more model braking', live=True),
                        ...
                        'spairrowtuning': Param(True, bool, 'INDI Tuning for Corolla'),
                        'speed_offset': Param(1.78, VT.number, 'Speed limit offset in m/s', live=True),
